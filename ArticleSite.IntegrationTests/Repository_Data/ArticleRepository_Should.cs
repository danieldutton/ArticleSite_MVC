...
namespace ArticleSite.IntegrationTests.Repository_Data
{
    ...
    public class ArticleRepository_Should
    {
        ...
        [Test]
        public void All_ReturnEveryArticleStored()
        {
        ...
        [Test]
        public void Find_FindCorrectArticleById_ThatExists()
        {
        ...
        [Test]
        public void Find_ReturnNull_IfArticleIdDoesNotExist()
        {
        ...
        [Test]
        public void Add_AddANewArticleToTheDatabase_UpdatingDuplicates()
        {
        ...
        {
            var expected = new DateTime(2014, 2, 24);
        ...
        public void LatestArticles_ReturnsCorrectMostRecentArticlesByLatestDate()
        {
            ...
            var expected1 = new DateTime(2014, 2, 24);
